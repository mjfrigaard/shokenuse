...
without writing any code — upload the CSV directly and it merges into the dashboard.
...
`launch_app()` opens the Shiny dashboard. The app starts empty — load data
from the **Data** tab using an Admin API key or by uploading a CSV.
