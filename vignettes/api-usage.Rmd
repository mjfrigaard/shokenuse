...
Open the **Data** tab, enter your `sk-ant-admin...` key, give the source a
**Machine label** (e.g. `"org-name"`), click **Fetch Usage**, then click
**Add to Dashboard**. Repeat with a different key to load data from another
organization — each fetch appends to the existing dashboard data.
